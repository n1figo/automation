...
def extract_and_process_tables(pdf_path, page_number, highlight_regions):
    # tabula를 사용하여 테이블 추출
    ...
    for table in tables:
        for row_index, row in table.iterrows():
            ...
            row["변경사항"] = "추가" if row_highlighted else "유지"
...
def main(pdf_path, output_excel_path):
    ...
    # Tabula를 사용하여 테이블 추출 및 처리
    processed_df = extract_and_process_tables(pdf_path, page_number, highlight_regions)
